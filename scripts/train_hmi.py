...
config_name = 'default'
pipe = ConfigPipeline([YamlConfig('./hmi_config.yaml', config_name='default', config_folder='config'),
...
# Loading the HMI dataset
train_loader, test_loaders, output_encoder = load_hmi_zarr(
        data_path=config.data.data_path, batch_size=config.data.batch_size,
